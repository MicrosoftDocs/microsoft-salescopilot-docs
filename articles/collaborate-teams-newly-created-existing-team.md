...
You can open a collaboration space&mdash;an account team or a deal room channel in Microsoft Teams&mdash;in various ways. Use the links below to jump to what you need:

- [Understand the anatomy of a collaboration space](#anatomy-of-a-collaboration-space)
- [View an AI-generated opportunity summary](#view-an-ai-generated-opportunity-summary-in-the-deal-room-channel)

- In Outlook, open the Sales agent, and then follow one of these steps:
  ...
  - Scroll down to the **Collaborate in Teams** card, and then select the account team name or, for opportunities, the opportunity channel name.
    ...
    :::image type="content" source="media/created-deal-room-viva-sales.png" alt-text="Screenshot of the Collaborate in Teams card in the Sales agent for Outlook, with the deal room channel highlighted.":::
...
- **CRM** displays the linked CRM account or opportunity record. You can view and update the CRM information in this tab.
  ...
  > - The CRM tab doesn't load in the new version of Teams. To see a CRM record in the new version of Teams, [use the Sales agent to share a customer's record as an adaptive card](share-crm-record-teams-conversation.md). Alternatively, you can use the classic version of Teams to view account or opportunity details in the CRM tab.
...
When you [set up a deal room](set-up-team-deal-room-template.md), the Sales agent in Teams and bot are automatically installed for the selected team. The first time you open the deal room channel, an AI-generated [opportunity summary](view-opportunity-summary.md) is included in the standard channel welcome post.

> [!NOTE]
> - If you're using Dynamics 365 as your CRM system, you can view opportunity summary even if you're not signed in to the Sales agent in Outlook or if you're signed in to a different Dynamics environment, as long as you have read access for the record and the Sales agent privileges. This applies only to the auto-posted opportunity summary.
> - If you're using Salesforce as your CRM system, you must be signed in to Salesforce in the Sales agent in Outlook to view opportunity summary while also having read access for the record and the Sales agent privileges.
...
If your administrator has turned off the Sales agent in Teams, the opportunity summary isn't available at all.
