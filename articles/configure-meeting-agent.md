...
Auto recording is applicable only to sales meetings that have the [Sales agent added automatically](create-teams-meeting.md#add-the-sales-agent-automatically-to-a-teams-meeting) before the meeting. 
...
1. In the Sales agent admin settings, select **Meeting insights**.
