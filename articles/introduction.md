...
Here's how you can use Sales app to improve your sales productivity:
...
- Administrators must be assigned either System Administrator or System Customizer security role to customize Sales app. If you're using a custom security role, [additional privileges are required to use Sales app](privileges.md#privileges-required-for-dynamics-365-customers).

- Users must be assigned either Sales Manager or Salesperson security role to use Sales app. If you're using a custom security role, [additional privileges are required to use Sales app](privileges.md#privileges-required-for-dynamics-365-customers).
...
> [!NOTE]
> Sales app is not supported in Government Community Cloud (GCC), including USG, and Department of Defense (DoD).
