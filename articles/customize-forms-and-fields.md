...
CRM administrators must access administrator settings from the Sales app in Teams. More information: [Administrator settings for Sales agent](administrator-settings-sales-app.md)
