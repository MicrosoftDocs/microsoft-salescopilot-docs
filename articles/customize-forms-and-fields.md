...
The mini view includes a fixed title and two configurable subtitle fields. The fields available in the mini view are the ones that are available in the detailed view. Key fields setting affect the Search behavior in the Sales agent for Outlook. More information: [Search behavior in Sales agent for Outlook](#search-behavior-in-sales-app-for-outlook)
