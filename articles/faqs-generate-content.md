...
description: This FAQ provides information about the AI technology used in the generate content feature in the Sales agent, along with key considerations and details about how AI is used, how it was tested and evaluated, and any specific limitations.
ms.date: 03/09/2026
ms.custom: 
  - responsible-ai-faqs
ms.topic: faq
...
These frequently asked questions (FAQ) describe the AI impact of the Sales agent's generate content feature in Outlook.

## What is generate content feature in Outlook?

The Sales agent empowers salespeople to be more productive with their time by generating email drafts for them to send to their customers. By leveraging generative AI, it provides valuable assistance in crafting effective and personalized communication, saving time and enhancing the seller's writing skills.
...
The Sales agent supports the following capabilities:
