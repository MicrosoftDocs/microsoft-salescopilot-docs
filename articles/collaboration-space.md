---
title: Collaboration spaces in the Sales agent
...
# Collaboration spaces in the Sales agent
...
- You must have a valid license. [Learn about the license requirements for the Sales agent](introduction.md#license-requirements).  
- You must have the Sales agent for Outlook installed. If you don't have it, ask your administrator to [install it](install-sales-app.md) for you.  
