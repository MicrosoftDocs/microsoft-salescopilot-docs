---
title: "msdyn_ocrecording table/entity reference (Copilot for Sales) | Microsoft Docs"
description: "Includes schema information and supported messages for the msdyn_ocrecording table/entity."
ms.date: 02/06/2024
...
# msdyn_ocrecording table/entity reference
...
- [msdyn_recordingtargetName](#BKMK_msdyn_recordingtargetName)
- [msdyn_recordingtargetYomiName](#BKMK_msdyn_recordingtargetYomiName)
...
### <a name="BKMK_msdyn_recordingtargetName"></a> msdyn_recordingtargetName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_recordingtargetname|
|MaxLength|1000|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_recordingtargetYomiName"></a> msdyn_recordingtargetYomiName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_recordingtargetyominame|
|MaxLength|1000|
|RequiredLevel|None|
|Type|String|
...
Same as the [msdyn_msdyn_sciconversation_OCRecording_msdyn_o](msdyn_sciconversation.md#BKMK_msdyn_msdyn_sciconversation_OCRecording_msdyn_o) many-to-one relationship for the [msdyn_sciconversation](msdyn_sciconversation.md) table/entity.
