...
> [!TIP]
> Want to learn how sellers use suggested tasks? See [Advanced collaboration with AI-powered Planner tasks](suggested-tasks-collab-space.md).
...
- [Access administrator settings](administrator-settings-sales-app.md#access-administrator-settings)
