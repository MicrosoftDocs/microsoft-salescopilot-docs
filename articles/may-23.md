...
| CRM customizations | Support to view Out-of-box (OOB) and custom entities | Administrators can add and remove OOB and custom entities and their corresponding fields through Viva Sales admin settings. They can also control the filtering and sorting behavior for CRM lists in the Outlook side pane.<br> Sellers can see the newly added OOB and custom entities in the Outlook side pane, share OOB and custom entities in Teams via adaptive cards, and search for OOB and custom entities in the Teams messaging extensions with the new **Advanced Search** functionality. | Outlook add-in<br /></br><br /></br>Microsoft Teams app | [Admin guide](customize-forms-and-fields.md#add-a-new-record-type-or-a-salesforce-object) <br><br> [Seller guide](https://support.microsoft.com/topic/share-a-crm-record-in-a-teams-conversation-e07cc6b4-9cc7-43ef-905e-b8ff0c8526ed#bkmk_advsearch) | Enabled by admin | General availability |
