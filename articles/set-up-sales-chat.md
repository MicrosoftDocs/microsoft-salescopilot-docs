...
## Step 6 (optional): Extend Sales agent with custom tools and knowledge

You can extend Sales agent with custom tools and knowledge to integrate data, enhance insights, and provide accurate responses. For more information, see [Extend Sales agent with custom tools and knowledge in the Microsoft 365 admin center](extend-sales-chat-custom-tools.md).
