...
# Use Lead Research and Outreach (preview)

[!INCLUDE [preview-banner](~/../shared-content/shared/preview-includes/preview-banner.md)]

[!INCLUDE [preview-note](~/../shared-content/shared/preview-includes/preview-note-d365.md)]

Lead Research and Outreach provides you with a comprehensive overview of the research conducted on your leads. This includes insights into the lead's company, recent news, and other relevant information that can help you tailor your outreach strategy. You can view this research in your CRM and in the Sales personal app.

## View leads researched in Sales personal app

When your administrator has enabled the Lead Research and Outreach, you can view the leads that are researched by the Lead Research and Outreach in the Sales personal app. 

1. Open the Sales personal app in Teams or Outlook.
1. Navigate to the **Home** tab of the app.
1. On the **Automated lead research with Sales Agent - Lead Research** card, select **View leads**.

    :::image type="content" source="./media/sales-agent-home.png" alt-text="Screenshot showing home page of Sales personal app with card for the Lead Research and Outreach.":::

    The **Leads researched by Sales Agent - Lead Research** page opens with a list of leads that are researched by Lead Research and Outreach. 

    :::image type="content" source="./media/sales-agent-lead-list.png" alt-text="Screenshot showing leads researched by Lead Research and Outreach in Sales personal app.":::
    ...
    > - Lead Research and Outreach automatically performs research on leads when they're created or modified in your CRM. You can see the status of the research progress on this list.

1. To view the research details for a lead, select the lead from the list. The lead research details page provides a summary of the research conducted by Lead Research and Outreach, including key insights and information about the lead's company. Learn more about the [lead research details](#view-lead-research-details-in-sales-personal-app).
...
1. Look for the **Sales Agent** section on the lead record page. This section contains the summary of the research conducted by Lead Research and Outreach.
...
- [Lead Research and Outreach overview](sales-agent-overview.md)
