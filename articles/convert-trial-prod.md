...
If you are using a non-Dynamics 365 CRM, such as Salesforce, the Sales app creates a trial Power Platform environment to store settings and some data for the running of the app. The name of the environment is **msdyn_viva**.
...
If you are using a non-Dynamics 365 CRM, such as Salesforce, the Sales app creates a trial Power Platform environment named **msdyn_viva**.
