...
description: Learn how to share key email info from Outlook to Teams using the Sales agent.
ms.date: 05/08/2026
ms.topic: how-to
...
You can share key email information generated by the Sales agent from Outlook to any individual chats, group chats, meetings or channels in Teams. Whether you're preparing for a meeting, updating your team on a new opportunity, or sharing crucial email details, this feature ensures that all relevant information is easily accessible within your team's preferred communication platform. This reduces the chances of miscommunication and ensures that everyone stays informed.

> [!NOTE]
> This capability is currently supported in Classic Outlook only. 
