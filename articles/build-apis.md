---
title: Build extensions for Sales agent (preview)
...
# Build extensions for Sales agent (preview)

[!INCLUDE [production-ready-preview-dynamics365](~/../shared-content/shared/preview-includes/production-ready-preview-dynamics365.md)]

[!INCLUDE [preview-banner](~/../shared-content/shared/preview-includes/preview-banner.md)]

This section outlines what Sales agent expects from your application APIs that either enhance an existing capability or introduce a new one. It covers the following aspects:

- The input context that your application APIs can expect from Sales agent (the capability)  
- The type of insights that each capability can show in the user interface (and therefore what your APIs should provide)  
- The descriptions that are needed at the API level, and for each API input and output, to help Sales agent identify the correct API to invoke at runtime
> [!NOTE]
...
This section provides the information that you need to enrich the following capabilities of Sales agent with insights from your application:
...
[Extend Sales agent with partner applications](extend-sales-app.md)
