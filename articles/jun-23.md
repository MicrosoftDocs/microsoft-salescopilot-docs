...
| Copilot | AI-generated e-mail summaries | Sellers can now save an e-mail summary to the account record, as well as the opportunity record. | Outlook add-in | [Seller guide](view-save-email-summary-crm.md) | Enabled by default for tenants in North America and Europe.</br><br>Enabled by admin for tenants in all other regions. | General availability |
