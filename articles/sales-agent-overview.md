...
Once configured, you can view summaries within your CRM or browse the Sales Agent's list of researched leads in the Sales agent. Learn more about how to [use Sales Agent](use-sales-agent.md).
