...
description: Learn about managing consumption-based billing for agent capabilities in the Sales agent.
ms.date: 11/20/2025
ms.topic: overview
...
> [!NOTE]
> Both billing models can be used on the Power Platform environment. Prepaid capacity is consumed first. Message capacity on the Power Platform environment is consumed by the Sales agent and other Microsoft services on the tenant.
