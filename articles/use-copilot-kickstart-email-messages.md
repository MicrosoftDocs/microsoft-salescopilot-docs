---
title: Draft an email message in Sales pane
...
# Draft an email message in Sales pane

When you compose a new email or reply to your customers by email, the **Sales** pane in Outlook uses AI to suggest content, saving you time and effort in composing the perfect message to move a deal forward. Choose from predefined response categories or enter your own text, and the AI generates the suggested content. You can use the suggested content as-is or modify to meet your needs.
...
> - If you've opened an encrypted email, the capability to draft an email using the **Sales** pane isn't available.
> - Based on the license you have, you can see the capability to draft an email message either [within Outlook](email-reply-premium.md) or in the **Sales** pane in Outlook.
...
1. In Outlook:
    ...
    - When you're reading an email, open the **Sales** pane.
...
1. Under **Relevant opportunity**, select the opportunity that you want the generated content to refer to.
   ...
   > [!NOTE]
   >
   > - The **Sales** pane displays opportunities that are related to the contacts in the email.
   >
...
With the **Sales** pane, you can summarize your most recent transcribed Teams meeting with your sales contacts and send it over email whenever you compose a new email or reply to your customer's email.

> [!IMPORTANT]
> Ensure that the Sales agent is installed, and meeting is transcribed to generate a meeting summary. More information: [Generate a meeting summary](create-teams-meeting.md#generate-a-meeting-summary)
...
1. In Outlook:
    ...
    - When you're composing a new email, open the **Sales** pane or select **Use Copilot now** in the banner message at the top of the email.
...
The Sales agent uses AI to generate suggested email content. Trained on a vast number of text samples from the Internet, Copilot generates new content that looks and sounds like it's written by a person.
...
When you open the **Sales** pane while you're reading or replying to an email, the AI considers the following information to generate a response:

- The contacts, subject, and body of the email

- CRM data connected through the Sales agent
