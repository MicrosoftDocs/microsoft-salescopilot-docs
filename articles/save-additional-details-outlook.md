...
CRM administrators must access admin settings from the Sales app app in Teams. For more information, go to [Sales app admin settings](administrator-settings-for-viva-sales.md).
...
1. In Sales app admin settings, select **Save to \<*type of CRM system*\>**.  
