...
As a tenant administrator or CRM (customer relationship management) administrator, you can use administrator settings to customize how your users experience Sales app in Outlook and Teams, including who can use AI capabilities, for all environments in your organization.
...
You can access the administrator settings in the Sales app in Outlook and Teams. The settings apply to the CRM environment that you sign in to. To customize Sales app for a different environment, [switch to that environment](sales-m365-copilot-faq.md#how-can-i-switch-crm-environments).
...
1. Change the settings you need to.  
    **Tenant-level settings**:  
      - **Copilot AI**: [Controls who can use Sales app AI capabilities in all environments](suggested-replies.md#turn-on-copilot-ai-features-for-your-organization).
    ...
    **Environment-level settings**:  
      ...
      - **Forms**: [Determines what information is displayed in Sales app in Outlook and Teams](customize-forms-and-fields.md). You can also control which records and fields sellers can edit directly in Sales app.
