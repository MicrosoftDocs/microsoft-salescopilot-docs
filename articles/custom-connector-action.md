...
> [!NOTE]
> - Actions enabled by your administrator could take up to seven days to be ingested in Copilot for Sales experiences. To force a quicker update, ask the users to sign out and then sign in again to Copilot for Sales in either Outlook or Teams.
