...
Sales personal app is the enhanced Teams personal app that has **Home** and **Settings** tabs available in Outlook and other Microsoft 365 apps. 
...
On the left navigation pane, select **View more apps** (**...**), and then search and select **Sales**.

## Home tab

The **Home** tab provides you with links to various resources, such as the Sales agent documentation and the feedback form. It also shows the environment name you are connected to. The environment name is displayed at the top-right corner of the **Home** tab.
...
If you have any feedback about the Sales agent, you can share it from the app. Your feedback is valuable, and we use it to improve the product.

1. Open the personal app in [Outlook](#open-the-personal-app-in-outlook) or [Teams](#open-the-personal-app-in-teams).

    The Sales agent is opened with the **Home** tab selected.
...
You can switch to another Dynamics 365 environment, without signing out of your current environment, from the Sales agent. 
