...
The **Customer communication** card in the Sales app in Outlook shows a chronological view of your interactions with a customer, including meetings. This card helps you catch up and gain insights into all the activities that have happened for a given opportunity. You can see all the meetings related to the opportunity. For each meeting, Sales app provides AI-generated insights such as the summary, sentiment, objections, and next steps.
