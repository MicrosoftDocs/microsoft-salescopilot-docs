...
The Sales agent scans the email conversations and compares the data with the data in the CRM system to suggest updates. The updates are suggested for the following fields in an opportunity record in CRM system:
...
1. In the **Sales** pane, go to the **Suggested actions** card.
...
1. Select **Update opportunity** for the update you want to apply. Based on whether the email is connected to an opportunity or not, the following happens:
    ...
    - If the email is connected to an opportunity, the opportunity form opens in the **Sales** pane.
...
You can also update an opportunity record with the suggested updates when viewing its details in the **Sales** pane. The updates are displayed in highlight cards above the opportunity details.

1. In the **Sales** pane, [view details of an opportunity](view-record-details.md).
