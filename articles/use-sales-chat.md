...
For a list of example prompts you can use with Sales agent, see [What can Sales agent help you with?](sales-chat-overview.md#what-can-sales-chat-help-you-with)
