...
> - The capabilities to save the email summary to your CRM and share it to Teams are not available when viewing the summary in the **Summary by Copilot** box within the new Outlook for Windows or Outlook on the web. They are only available in the **Key email info** card in the **Sales** pane in Classic Outlook for Windows. 
