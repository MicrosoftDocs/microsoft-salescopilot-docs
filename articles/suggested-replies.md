...
Copilot AI features in the Sales app are available only in some [supported languages](introduction.md#supported-languages-and-geographies).
...
As a tenant administrator, you can control who can use AI capabilities in the Sales app for all environments in your organization. If you turn off Copilot AI features for your organization, CRM administrators can't turn them on in their environments.
...
1. Under **Apply to**, select one of the following options:
    ...
    :::image type="content" source="media/viva-sales-tenant-admin.png" alt-text="Screenshot of the Sales app settings for a tenant.":::

1. Select **Save**.

## Turn on Copilot AI features in your environment

As a CRM administrator, you can control who can use AI capabilities in the Sales app in the environments you manage. If a tenant admin turned off Copilot AI features for your organization, you can't turn them on in your environments.
...
1. Select **Save**.  
    ...
    :::image type="content" source="media/viva-sales-crm-admin.png" alt-text="Screenshot of the Sales app settings for an environment.":::
